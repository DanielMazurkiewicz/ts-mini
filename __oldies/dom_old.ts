...
import { TDate, tDateToString, stringToTDate, TTime, tTimeToString, stringToTTime } from '../utils/dateTime';
...
export const decorator = <T>(definition: Function) => {
